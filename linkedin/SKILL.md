...
Before posting or commenting, **always apply the humanizer skill**. AI-generated LinkedIn content is obvious and damages credibility.

**Kill these patterns:**
- "I'm thrilled to announce..." → Just announce it
- "Here are 3 key takeaways..." → Rule of three is AI-slop
- "This is a testament to..." → Inflated symbolism
- Em dashes everywhere — like this — stop it
- "Additionally," "Moreover," "Furthermore" → AI vocabulary
- Fake excitement: "🚀 Excited to share!" → Nobody talks like this

**Write like a human:**
- Have opinions: "Honestly, I'm not sure this is the right approach"
- Vary sentence length. Short. Then longer when the thought needs room.
- First person is fine: "Here's what I found..." not "It was discovered that..."
- Be specific: "Took 3 weeks and 47 failed deploys" > "After much effort"
- Acknowledge uncertainty: "I could be wrong, but..."

**Before posting, ask:** Would I actually say this out loud to a coworker?
